...
int ArgumentHandler::processArguments() {
  ...
  { "alwayssplitvars", required_argument, 0, 'A' }, { "depvarname", required_argument, 0, 'D' }, { "memmode",
      required_argument, 0, 'M' }, { "predict", required_argument, 0, 'P' },
      { "splitweights", required_argument, 0, 'S' }, { "nthreads", required_argument, 0, 'U' }, { "version",
          no_argument, 0, 'Z' },

      { "file", required_argument, 0, 'f' }, { "help", no_argument, 0, 'h' },
      { "impmeasure", required_argument, 0, 'i' }, { "targetpartitionsize", required_argument, 0, 'l' }, { "mtry",
          required_argument, 0, 'm' }, { "outprefix", required_argument, 0, 'o' },
      { "probability", no_argument, 0, 'p' }, { "splitrule", required_argument, 0, 'r' }, { "statusvarname",
          required_argument, 0, 's' }, { "ntree", required_argument, 0, 't' }, { "noreplace", no_argument, 0, 'u' }, {
          "verbose", no_argument, 0, 'v' }, { "write", no_argument, 0, 'w' }, { "treetype", required_argument, 0, 'y' },
...
void ArgumentHandler::displayHelp() {
  ...
  std::cout << "    " << "--mtry N                      Number of variables to possibly split at in each node."
      << std::endl;
  std::cout << "    "
      << "                              (Default: sqrt(p) for Classification and Survival, p/3 for Regression. "
      << std::endl;
  ...
  std::cout << "    "
      << "                              TYPE = 1: Node impurity: Gini for Classification, variance for Regression."
      << std::endl;
