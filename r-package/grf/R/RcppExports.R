...
local_linear_predict_oob <- function(forest, input_data, sparse_input_data, lambda, ridge_type, num_threads) {
    .Call('_grf_local_linear_predict_oob', PACKAGE = 'grf', forest, input_data, sparse_input_data, lambda, ridge_type, num_threads)
}
