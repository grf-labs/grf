...
multi_causal_predict <- function(forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, num_treatments, num_threads, estimate_variance)
}

multi_causal_predict_oob <- function(forest_object, train_matrix, sparse_train_matrix, num_treatments, num_threads, estimate_variance) {
    .Call('_grf_multi_causal_predict_oob', PACKAGE = 'grf', forest_object, train_matrix, sparse_train_matrix, num_treatments, num_threads, estimate_variance)
}
