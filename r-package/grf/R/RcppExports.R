...
ll_causal_predict <- function(forest, input_data, training_data, sparse_input_data, sparse_training_data, outcome_index, treatment_index, instrument_index, lambdas, use_weighted_penalty, linear_correction_variables, num_threads) {
    .Call('_grf_ll_causal_predict', PACKAGE = 'grf', forest, input_data, training_data, sparse_input_data, sparse_training_data, outcome_index, treatment_index, instrument_index, lambdas, use_weighted_penalty, linear_correction_variables, num_threads)
}

ll_causal_predict_oob <- function(forest, input_data, sparse_input_data, outcome_index, treatment_index, instrument_index, lambdas, use_weighted_penalty, linear_correction_variables, num_threads) {
    .Call('_grf_ll_causal_predict_oob', PACKAGE = 'grf', forest, input_data, sparse_input_data, outcome_index, treatment_index, instrument_index, lambdas, use_weighted_penalty, linear_correction_variables, num_threads)
}
