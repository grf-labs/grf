...
local_linear_predict <- function(forest, input_data, training_data, sparse_input_data, lambda, ridge_type, num_threads) {
    .Call('_grf_local_linear_predict', PACKAGE = 'grf', forest, input_data, training_data, sparse_input_data, lambda, ridge_type, num_threads)
}
