...
instrumental_train <- function(input_data, sparse_input_data, outcome_index, treatment_index, instrument_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, clusters, samples_per_cluster) {
    .Call('_grf_instrumental_train', PACKAGE = 'grf', input_data, sparse_input_data, outcome_index, treatment_index, instrument_index, mtry, num_trees, num_threads, min_node_size, sample_fraction, seed, honesty, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, clusters, samples_per_cluster)
}
