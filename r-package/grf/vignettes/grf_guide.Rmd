...
rate.oob
```
which is insignificant and suggests the CATEs do not have much discriminating power. Note that we use OOB predictions for evaluation, this is a crucial component in retaining valid inference: separate fitting from evaluation. Forest-based methods are convenient in this regards as "out of sample/cross-fit" estimates comes for free in the form of out-of-bag estimates.
