...
### Final statistical ingredient: Gaining efficiency with doubly robust estimates
We briefly mentioned performing that Robinson's residual-on-residual  


note on efficiency when doing nonparam estimation, trades of flexibility for more uncertainty

 (remember that machine learning methods, while more flexible, converge at slower rates than typical parametric models, and so properties like orhtogonality is an important ingredient when using these tools for valid inference and estimation)
