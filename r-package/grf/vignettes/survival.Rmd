...
df$distribution <- c(rep("Survival time (T)", nrow(dens.cens)), rep("Observed (D*T)", nrow(dens.obs)))
df$distribution <- factor(df$distribution, levels = c("Survival time (T)", "Observed (D*T)"))
...
df$distribution <- factor(df$distribution, levels = c("Survival time (T)", "Observed (D*T)", "Truncate"))
