...
* [This review article](https://arxiv.org/abs/2312.02482) walks through an application of `causal_survival_forest` to analyze heterogeneity in unemployment duration using data from an RCT.

* [This handbook chapter](https://arxiv.org/abs/2207.07758) by Xu et al. (2022) gives some examples of how to use `grf` to construct inverse-probability-of-censoring weighting estimators.
