...
The tool we propose to employ in this situation is the "RATE". The RATE has two components: the "TOC" and the area under the TOC, which we explain in the following section.
