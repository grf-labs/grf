...
test_that("average effects are translation invariant", {
	...
	Y.plus.1 = Y + 1
	forest.causal = causal_forest(seed=1, X, Y, W, num.trees = 200, ci.group.size = 4)
...
test_that("average treatment effect estimates are reasonable", {
  ...
  forest.causal = causal_forest(seed=1, X, Y, W, num.trees = 500, ci.group.size = 1)
...
test_that("average partial effect estimates are reasonable", {
  ...
  TAU = 4 * (X[,1] > 0)
  Y =  TAU * (W  - 0.5) + rnorm(n)
  forest.causal = causal_forest(seed=1, X, Y, W, num.trees = 500,
...
test_that("average treatment effects larger example works", {
  ...
  forest.causal = causal_forest(seed=1, X, Y, W, num.trees = 1000, ci.group.size = 1)
...
test_that("cluster robust average effects are consistent", {
  ...
  forest.causal = causal_forest(seed=1, X, Y, W, num.trees = 1000, ci.group.size = 4)
  forest.causal.clust = causal_forest(seed=1, Xc, Yc, Wc, num.trees = 1000,
...
test_that("cluster robust average effects do weighting correctly", {
  ...
  forest.causal = causal_forest(seed=1, X, Y, W, clusters = clust, num.trees = 400)
...
test_that("cluster robust average effects do weighting correctly with IPCC weights", {
  ...
  forest.weighted = causal_forest(seed=1, X[cc,], Y[cc], W[cc], sample.weights = sample.weights[cc], clusters = clust[cc], num.trees = 400)
  forest.unweighted = causal_forest(seed=1, X[cc,], Y[cc], W[cc], clusters = clust[cc], num.trees = 400)
...
test_that("average effect estimation doesn't error on data with a single feature", {
  ...
  forest = causal_forest(seed=1, X,Y,W)
