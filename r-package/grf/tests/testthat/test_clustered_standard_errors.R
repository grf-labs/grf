...
test_that("Clustered standard errors are greater than unclustered", {
  ...
  expect_equal(mean_no_cluster, mean_corrected, tolerance = 0.15 * mean_no_cluster)
  expect_equal(mean_no_cluster, mean_corrected_no_cluster, tolerance = 0.15 * mean_no_cluster)
