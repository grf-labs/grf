...
TEST_CASE("Testing for seg fault", "[local_linear, forest]"){
  Data* data = load_data("test/forest/resources/friedman_2.csv");
  uint outcome_index = 20;
  std::vector<size_t> linear_correction_variables = {0, 1, 2, 3, 4};
