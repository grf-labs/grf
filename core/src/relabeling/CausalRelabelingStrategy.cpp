...
#include "relabeling/CausalRelabelingStrategy.h"

CausalRelabelingStrategy::CausalRelabelingStrategy():
  reduced_form_weight(0) {}

CausalRelabelingStrategy::CausalRelabelingStrategy(double reduced_form_weight):
  reduced_form_weight(reduced_form_weight) {}

std::unordered_map<size_t, double> CausalRelabelingStrategy::relabel(
