 ...
 * with a multivariate treatment = instrument, and a real-valued outcome Y.
 *
 * We estimate a forest weighted (alpha) estimate of beta in
 * Y = const + beta W + e, where Y is a real valued outcome and W a k-treatment matrix.
 ...
 * statistics (two doubles for the outcome and weight, num_treatments *
