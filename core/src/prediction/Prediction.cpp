...
const std::vector<double>& Prediction::get_monte_carlo_error_estimates() const {
  return monte_carlo_error_estimates;
}
...
const bool Prediction::contains_monte_carlo_error_estimates() const {
  return !monte_carlo_error_estimates.empty();
}
