...
// psi_{mu,tau}^1(Yi, Wi, Zi, Gi) = Gi (Yi - Wi tau - mu),
//
...
//
// We the estimate all conditional expectations via forest weighting.
...
// Continuing from above, the Hessian V(x) associated with our estimating eqution is
//
...
//
// rhoi = hat{V}^{-1} psi_{hat{mu}, hat{tau}}(Yi, Wi, Zi, Gi)
