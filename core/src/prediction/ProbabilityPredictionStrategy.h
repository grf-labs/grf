...
class ProbabilityPredictionStrategy final: public OptimizedPredictionStrategy {
public:
  ProbabilityPredictionStrategy(size_t num_classes);
...
#endif //GRF_PROBABILITYPREDICTIONSTRATEGY_H
