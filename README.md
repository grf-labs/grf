...
Note that to install from source, a compiler that implements C++11 or higher is required (clang 3.3 or higher, or g++ 4.8 or higher). If installing on Windows, the RTools toolchain is also required.
